...
public interface flyerDao extends JpaRepository<flyerVo,Integer> {
    ...
    List<flyerVo>findByStoreId(int storeId,int sameStoreid,int page,int pageSize);
    ...
    List<flyerVo>findByDay(Timestamp start,Timestamp end,int storeId,Timestamp sameStart,Timestamp sameEnd,int sameStoreId,int page,int pageSize);
}
